...
def create_prec_stats
  ...
  PrecStat.create!(code: 'P221', description: 'Take any precaution to avoid mixing with combustibles/....')
  ...
  PrecStat.create!(code: 'P230', description: 'Keep wetted with ....')
  ...
  PrecStat.create!(code: 'P241', description: 'Use explosion-proof equipment.')
  ...
  PrecStat.create!(code: 'P250', description: 'Do not subject to grinding/shock/friction/....')
  PrecStat.create!(code: 'P251', description: 'Do not pierce or burn, even after use.')
  PrecStat.create!(code: 'P260', description: 'Do not breathe dust/fume/gas/mist/vapors/spray.')
  PrecStat.create!(code: 'P261', description: 'Avoid breathing dust/fume/gas/mist/vapors/spray.')
  ...
  PrecStat.create!(code: 'P264', description: 'Wash hands thoroughly after handling.')
  ...
  PrecStat.create!(code: 'P231+P232', description: 'Handle under inert gas/.... Protect from moisture.')
  PrecStat.create!(code: 'P235+P410', description: 'Keep cool. Protect from sunlight.')
  PrecStat.create!(code: 'P301', description: 'IF SWALLOWED:')
  PrecStat.create!(code: 'P302', description: 'IF ON SKIN:')
  PrecStat.create!(code: 'P303', description: 'IF ON SKIN (or hair):')
  PrecStat.create!(code: 'P304', description: 'IF INHALED:')
  PrecStat.create!(code: 'P305', description: 'IF IN EYES:')
  PrecStat.create!(code: 'P306', description: 'IF ON CLOTHING:')
  PrecStat.create!(code: 'P307', description: 'IF exposed:')
  ...
  PrecStat.create!(code: 'P310', description: 'Immediately call a POISON CENTER or doctor.')
  PrecStat.create!(code: 'P311', description: 'Call a POISON CENTER or doctor.')
  PrecStat.create!(code: 'P312', description: 'Call a POISON CENTER or doctor if you feel unwell.')
  ...
  PrecStat.create!(code: 'P320', description: 'Specific treatment is urgent (see ... on this label).')
  PrecStat.create!(code: 'P321', description: 'Specific treatment (see ... on this label).')
  PrecStat.create!(code: 'P322', description: 'Specific measures (see ... on this label).')
  PrecStat.create!(code: 'P330', description: 'Rinse mouth.')
  PrecStat.create!(code: 'P331', description: 'Do NOT induce vomiting.')
  PrecStat.create!(code: 'P332', description: 'IF SKIN irritation occurs:')
  PrecStat.create!(code: 'P333', description: 'If skin irritation or rash occurs:')
  ...
  PrecStat.create!(code: 'P352', description: 'Wash with plenty of water.')
  ...
  PrecStat.create!(code: 'P378', description: 'Use ... to extinguish.')
  ...
  PrecStat.create!(code: 'P301+P310', description: 'IF SWALLOWED: Immediately call a POISON CENTER or doctor.')
  PrecStat.create!(code: 'P301+P330', description: 'IF SWALLOWED: Rinse mouth.')
  PrecStat.create!(code: 'P301+P310+P331', description: 'IF SWALLOWED: Immediately call a POISON CENTER or doctor. Do NOT induce vomiting.')
  PrecStat.create!(code: 'P301+P310+P330', description: 'IF SWALLOWED: Immediately call a POISON CENTER or doctor. Rinse mouth.')
  PrecStat.create!(code: 'P301+P312', description: 'IF SWALLOWED: call a POISON CENTER or doctor IF you feel unwell.')
  PrecStat.create!(code: 'P301+P312+P330', description: 'IF SWALLOWED: call a POISON CENTER or doctor if you feel unwell. Rinse mouth.')
  PrecStat.create!(code: 'P301+P330+P331', description: 'IF SWALLOWED: Rinse mouth. Do NOT induce vomiting.')
  PrecStat.create!(code: 'P301+P330+P331+P310', description: 'IF SWALLOWED: Rinse mouth. Do NOT induce vomiting. Immediately call a POISON CENTER or doctor.')
  ...
  PrecStat.create!(code: 'P302+P350+P310', description: 'IF ON SKIN: Gently wash with plenty of soap and water. Immediately call a POISON CENTER or doctor.')
  PrecStat.create!(code: 'P302+P352', description: 'IF ON SKIN: wash with plenty of water.')
  PrecStat.create!(code: 'P302+P352+P332+P313+P362+P364', description: 'IF ON SKIN: wash with plenty of water. IF SKIN irritation occurs: Get medical advice/attention. Take off contaminated clothing and wash it before reuse.')
  PrecStat.create!(code: 'P302+P352+P312', description: 'IF ON SKIN: wash with plenty of water. Call a POISON CENTER or doctor if you feel unwell.')
  PrecStat.create!(code: 'P302+P352+P310', description: 'IF ON SKIN: wash with plenty of water. Immediately call a POISON CENTER or doctor/physician.')
  ...
  PrecStat.create!(code: 'P303+P361+P353+P310+P363', description: 'IF ON SKIN (or hair): Take off Immediately all contaminated clothing. Rinse SKIN with water (or shower). Immediately call a POISON CENTER or doctor/physician. Wash contaminated clothing before reuse.')
  PrecStat.create!(code: 'P303+P361', description: 'IF ON SKIN (or hair): Take off Immediately all contaminated clothing.')
  PrecStat.create!(code: 'P304+P312', description: 'IF INHALED: Call a POISON CENTER or doctor if you feel unwell.')
  PrecStat.create!(code: 'P304+P340+P312', description: 'IF INHALED: Remove person to fresh air and keep comfortable for breathing. Call a POISON CENTER or doctor if you feel unwell.')
  PrecStat.create!(code: 'P304+P340+P311', description: 'IF INHALED: Remove person to fresh air and keep comfortable for breathing. Call a POISON CENTER or doctor.')
  PrecStat.create!(code: 'P304+P340', description: 'IF INHALED: Remove person to fresh air and keep comfortable for breathing.')
  PrecStat.create!(code: 'P304+P340+P310', description: 'IF INHALED: Remove person to fresh air and keep comfortable for breathing. Immediately call a POISON CENTER or doctor.')
  ...
  PrecStat.create!(code: 'P305+P351', description: 'IF IN EYES: Rinse cautiously with water for several minutes.')
  ...
  PrecStat.create!(code: 'P305+P351+P338+P337+P313', description: 'IF IN EYES: Rinse cautiously with water for several minutes. Remove contact lenses if present and easy to do - continue rinsing. If eye irritation persists: Get medical advice/attention.')
  PrecStat.create!(code: 'P305+P351+P338+P310', description: 'IF IN EYES: Rinse cautiously with water for several minutes. Remove contact lenses if present and easy to do - continue rinsing. Immediately call a POISON CENTER or doctor.')
  ...
  PrecStat.create!(code: 'P307+P311', description: 'IF exposed: call a POISON CENTER or doctor.')
  PrecStat.create!(code: 'P308+P311', description: 'IF exposed or concerned: Call a POISON CENTER or doctor')
  PrecStat.create!(code: 'P308+P310', description: 'IF exposed or concerned: Immediately call a POISON CENTER or doctor')
  PrecStat.create!(code: 'P308+P313', description: 'IF exposed or concerned: Get medical advice/attention.')
  PrecStat.create!(code: 'P309+P311', description: 'IF exposed or if you feel unwell: Call a POISON CENTER or doctor.')
  PrecStat.create!(code: 'P309+P310', description: 'IF exposed or if you feel unwell: Immediately call a POISON CENTER or doctor')
  ...
  PrecStat.create!(code: 'P342+P311', description: 'IF experiencing respiratory symptoms: Call a POISON CENTER or doctor.')
  ...
  PrecStat.create!(code: 'P370+P378', description: 'In case of fire: Use ... to extinguish.')
  ...
  PrecStat.create!(code: 'P401', description: 'Store in accordance with ....')
  ...
  PrecStat.create!(code: 'P406', description: 'Store in corrosive resistant/... container with a resistant inner liner.')
  ...
  PrecStat.create!(code: 'P411', description: 'Store at temperatures not exceeding ....')
  PrecStat.create!(code: 'P412', description: 'Do not expose to temperatures exceeding ....')
  PrecStat.create!(code: 'P413', description: 'Store bulk masses greater than ... at temperatures not exceeding ....')
  PrecStat.create!(code: 'P420', description: 'Store separately.')
  PrecStat.create!(code: 'P422', description: 'Store contents under ...')
  ...
  PrecStat.create!(code: 'P410+P412', description: 'Protect from sunlight. Do not expose to temperatures exceeding 50 °C/122 °F.')
  PrecStat.create!(code: 'P411+P235', description: 'Store at temperatures not exceeding .... Keep cool.')
  PrecStat.create!(code: 'P501', description: 'Dispose of contents/container to ....')
...
#http://www.chemsafetypro.com/Topics/GHS/GHS_hazard_statement_h_code.html
  ...
  HazStat.create!(code: 'H350i', description: 'May cause cancer by inhalation')
  ...
  HazStat.create!(code: 'H360FD', description: 'May damage fertility; May damage the unborn child')
  HazStat.create!(code: 'H360D', description: 'May damage the unborn child')
  HazStat.create!(code: 'H360Df', description: 'May damage the unborn child; Suspected of damaging fertility')
  HazStat.create!(code: 'H360Fd', description: 'May damage fertility; Suspected of damaging the unborn child')
  HazStat.create!(code: 'H360F', description: 'May damage fertility')
  HazStat.create!(code: 'H361', description: 'Suspected of damaging fertility or the unborn child')
  HazStat.create!(code: 'H361fd', description: 'Suspected of damaging fertility; Suspected of damaging the unborn child')
  HazStat.create!(code: 'H361d', description: 'Suspected of damaging the unborn child')
  HazStat.create!(code: 'H361f', description: 'Suspected of damaging fertility')
...
def create_haz_class_division(haz_class, description)
  HazClass.create! do |i|
    i.description = description
    i.superclass_id = haz_class.id
  end
end

def create_haz_classes
  explosives = HazClass.create!(description: 'Explosives')
  create_haz_class_division(explosives, 'Category 1')
  create_haz_class_division(explosives, 'Category 2A')
  create_haz_class_division(explosives, 'Category 2B')
  create_haz_class_division(explosives, 'Category 2C')
  flammable_gases = HazClass.create!(description: 'Flammable gases')
  create_haz_class_division(flammable_gases, 'Category 1A - Flammable gas')
  create_haz_class_division(flammable_gases, 'Category 1A -  Pyrophoric gas')
  create_haz_class_division(flammable_gases, 'Category 1A - Chemically unstable gas A')
  create_haz_class_division(flammable_gases, 'Category 1A - Chemically unstable gas B')
  create_haz_class_division(flammable_gases, 'Category 1B')
  create_haz_class_division(flammable_gases, 'Category 2')
  aerosols = HazClass.create!(description: 'Aerosols')
  create_haz_class_division(aerosols, 'Category 1')  
  create_haz_class_division(aerosols, 'Category 2')
  create_haz_class_division(aerosols, 'Category 3')
  oxidising_gases = HazClass.create!(description: 'Oxidising gases')
  create_haz_class_division(oxidising_gases, 'Category 1')
  chemicals_under_pressure = HazClass.create!(description: 'Chemicals under pressure')
  create_haz_class_division(chemicals_under_pressure, 'Category 1') 
  create_haz_class_division(chemicals_under_pressure, 'Category 2')
  create_haz_class_division(chemicals_under_pressure, 'Category 3')
  gases_under_pressure = HazClass.create!(description: 'Gases under pressure')
  create_haz_class_division(gases_under_pressure, 'Compressed gas')  
  create_haz_class_division(gases_under_pressure, 'Liquefied gas')  
  create_haz_class_division(gases_under_pressure, 'Refrigerated liquefied gas')  
  create_haz_class_division(gases_under_pressure, 'Dissolved gas')  
  flammable_liquids = HazClass.create!(description: 'Flammable liquids')
  create_haz_class_division(flammable_liquids, 'Category 1') 
  create_haz_class_division(flammable_liquids, 'Category 2')
  create_haz_class_division(flammable_liquids, 'Category 3')
  create_haz_class_division(flammable_liquids, 'Category 4')
  flammable_solids = HazClass.create!(description: 'Flammable solids')
  create_haz_class_division(flammable_solids, 'Category 1') 
  create_haz_class_division(flammable_solids, 'Category 2')
  self_reactive = HazClass.create!(description: 'Self-reactive substances')
  create_haz_class_division(self_reactive, 'Type A') 
  create_haz_class_division(self_reactive, 'Type B') 
  create_haz_class_division(self_reactive, 'Type C and D') 
  create_haz_class_division(self_reactive, 'Type E and F') 
  create_haz_class_division(self_reactive, 'Type G') 
  pyrophoric_solids = HazClass.create!(description: 'Pyrophoric solids')
  create_haz_class_division(pyrophoric_solids, 'Category 1') 
  pyrophoric_liquids = HazClass.create!(description: 'Pyrophoric liquids')
  create_haz_class_division(pyrophoric_liquids, 'Category 1') 
  self_heating = HazClass.create!(description: 'Self-heating substances')
  create_haz_class_division(self_heating, 'Category 1') 
  create_haz_class_division(self_heating, 'Category 2') 
  water_flammable_gas = HazClass.create!(description: 'Substances which in contact with water emit flammable gases')
  create_haz_class_division(water_flammable_gas, 'Category 1') 
  create_haz_class_division(water_flammable_gas, 'Category 2') 
  create_haz_class_division(water_flammable_gas, 'Category 3') 
  oxidising_liquids = HazClass.create!(description: 'Oxidising liquids')
  create_haz_class_division(oxidising_liquids, 'Category 1') 
  create_haz_class_division(oxidising_liquids, 'Category 2') 
  create_haz_class_division(oxidising_liquids, 'Category 3') 
  oxidising_solids = HazClass.create!(description: 'Oxidising solids')
  create_haz_class_division(oxidising_solids, 'Category 1') 
  create_haz_class_division(oxidising_solids, 'Category 2') 
  create_haz_class_division(oxidising_solids, 'Category 3') 
  organic_peroxides = HazClass.create!(description: 'Organic peroxides')
  create_haz_class_division(organic_peroxides, 'Type A') 
  create_haz_class_division(organic_peroxides, 'Type B') 
  create_haz_class_division(organic_peroxides, 'Type C and D') 
  create_haz_class_division(organic_peroxides, 'Type E and F') 
  create_haz_class_division(organic_peroxides, 'Type G') 
  corrosive_metal = HazClass.create!(description: 'Substances corrosive to metal')
  create_haz_class_division(corrosive_metal, 'Category 1') 
  desensitized_explosives = HazClass.create!(description: 'Desensitised explosives')
  create_haz_class_division(desensitized_explosives, 'Category 1') 
  create_haz_class_division(desensitized_explosives, 'Category 2') 
  create_haz_class_division(desensitized_explosives, 'Category 3') 
  create_haz_class_division(desensitized_explosives, 'Category 4') 
  acute_tox_oral = HazClass.create!(description: 'Acute toxicity - Oral')
  acute_tox_dermal = HazClass.create!(description: 'Acute toxicity - Dermal')
  acute_tox_inhalation = HazClass.create!(description: 'Acute toxicity - Inhalation')
  create_haz_class_division(acute_tox_oral, 'Category 1') 
  create_haz_class_division(acute_tox_oral, 'Category 2') 
  create_haz_class_division(acute_tox_oral, 'Category 3') 
  create_haz_class_division(acute_tox_oral, 'Category 4') 
  create_haz_class_division(acute_tox_oral, 'Category 5') 
  create_haz_class_division(acute_tox_dermal, 'Category 1') 
  create_haz_class_division(acute_tox_dermal, 'Category 2') 
  create_haz_class_division(acute_tox_dermal, 'Category 3') 
  create_haz_class_division(acute_tox_dermal, 'Category 4') 
  create_haz_class_division(acute_tox_dermal, 'Category 5') 
  create_haz_class_division(acute_tox_inhalation, 'Category 1') 
  create_haz_class_division(acute_tox_inhalation, 'Category 2') 
  create_haz_class_division(acute_tox_inhalation, 'Category 3') 
  create_haz_class_division(acute_tox_inhalation, 'Category 4') 
  create_haz_class_division(acute_tox_inhalation, 'Category 5') 
  skin_corrosion = HazClass.create!(description: 'Skin corrosion')
  create_haz_class_division(skin_corrosion, 'Category 1') 
  create_haz_class_division(skin_corrosion, 'Category 1A') 
  create_haz_class_division(skin_corrosion, 'Category 1B') 
  create_haz_class_division(skin_corrosion, 'Category 1C')
  create_haz_class_division(skin_corrosion, 'Category 2') 
  create_haz_class_division(skin_corrosion, 'Category 3') 
  skin_irritation = HazClass.create!(description: 'Skin irritation')
  create_haz_class_division(skin_irritation, 'Category 1') 
  create_haz_class_division(skin_irritation, 'Category 1A') 
  create_haz_class_division(skin_irritation, 'Category 1B') 
  create_haz_class_division(skin_irritation, 'Category 1C')
  create_haz_class_division(skin_irritation, 'Category 2') 
  create_haz_class_division(skin_irritation, 'Category 3') 
  eye_damage = HazClass.create!(description: 'Serious eye damage')
  create_haz_class_division(eye_damage, 'Category 1') 
  create_haz_class_division(eye_damage, 'Category 2') 
  create_haz_class_division(eye_damage, 'Category 2A') 
  create_haz_class_division(eye_damage, 'Category 2B')
  repsiratory_sensitisation = HazClass.create!(description: 'Respiratory sensitisation')
  create_haz_class_division(repsiratory_sensitisation, 'Category 1') 
  create_haz_class_division(repsiratory_sensitisation, 'Category 1A') 
  create_haz_class_division(repsiratory_sensitisation, 'Category 1B') 
  skin_sensitisation = HazClass.create!(description: 'Skin sensitisation')
  create_haz_class_division(skin_sensitisation, 'Category 1') 
  create_haz_class_division(skin_sensitisation, 'Category 1A') 
  create_haz_class_division(skin_sensitisation, 'Category 1B') 
  germ_cell_mutagenicity = HazClass.create!(description: 'Germ cell mutagenicity')
  create_haz_class_division(germ_cell_mutagenicity, 'Category 1') 
  create_haz_class_division(germ_cell_mutagenicity, 'Category 1A') 
  create_haz_class_division(germ_cell_mutagenicity, 'Category 1B')
  create_haz_class_division(germ_cell_mutagenicity, 'Category 2') 
  carcinogenicity = HazClass.create!(description: 'Carcinogenicity')
  create_haz_class_division(carcinogenicity, 'Category 1') 
  create_haz_class_division(carcinogenicity, 'Category 1A') 
  create_haz_class_division(carcinogenicity, 'Category 1B')
  create_haz_class_division(carcinogenicity, 'Category 2') 
  reprotoxic = HazClass.create!(description: 'Reproductive toxicity')
  create_haz_class_division(reprotoxic, 'Category 1') 
  create_haz_class_division(reprotoxic, 'Category 1A') 
  create_haz_class_division(reprotoxic, 'Category 1B')
  create_haz_class_division(reprotoxic, 'Category 2') 
  target_single = HazClass.create!(description: 'Target organ systemic toxicity: single exposure')
  create_haz_class_division(target_single, 'Category 1') 
  create_haz_class_division(target_single, 'Category 2') 
  create_haz_class_division(target_single, 'Category 3') 
  target_repeat = HazClass.create!(description: 'Target organ systemic toxicity: repeated exposure')
  create_haz_class_division(target_repeat, 'Category 1') 
  create_haz_class_division(target_repeat, 'Category 2') 
  aspiration = HazClass.create!(description: 'Aspiration toxicity')
  create_haz_class_division(aspiration, 'Category 1') 
  create_haz_class_division(aspiration, 'Category 2') 
  aquatic_acute = HazClass.create!(description: 'Acute aquatic toxicity')
  create_haz_class_division(aquatic_acute, 'Category 1') 
  create_haz_class_division(aquatic_acute, 'Category 2') 
  create_haz_class_division(aquatic_acute, 'Category 3') 
  aquatic_chronic = HazClass.create!(description: 'Chronic aquatic toxicity')
  create_haz_class_division(aquatic_chronic, 'Category 1') 
  create_haz_class_division(aquatic_chronic, 'Category 2') 
  create_haz_class_division(aquatic_chronic, 'Category 3') 
  create_haz_class_division(aquatic_chronic, 'Category 4') 
  ozone = HazClass.create!(description: 'Hazardous to the ozone layer')
  create_haz_class_division(ozone, 'Category 1') 
end
